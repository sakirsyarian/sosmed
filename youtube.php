...
<html>
	<head><meta charset="windows-1252"> 
		...
		<title>Kelola Youtube | WebsiteOri</title>
		
      <!-- <link rel="shortcut icon" href="https://gosocial.co.id/assets/customer/images/logo/favicon.png">
		<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no">
		<meta name="title" content="Jasa Tambah Subscribers, Viewers, dan Likes Youtube - GoSocial">
		<meta name="description" content="Tingkatkan interaksi channel Youtube anda secara cepat dengan Beli Subscriber Youtube, Likes, hingga Views untuk meningkatkan value video channel Youtube.">
		<meta name="keywords" content="beli subscriber youtube, jual subscriber youtube, beli view youtube, cara menambah subscriber">
		<meta name="csrf-token" content="WoSVYBdI5iE59tSI5Q3N7tQZjTCqTmgEVhh71fuw">
		<meta name="copyright" content="GoSocial Indonesia">
		<meta name="language" content="id">
		<meta name="robots" content="index,follow" />
		<meta name="ahrefs-site-verification" content="45e293851ec10c2ef7ad4e27b710bd0a8f918b569a15acd14c30445bbb2e36db">
...
<section class="new_breadcrumb_area">
   ...
   <div class="container">
      <h1>Kelola Youtube</h1>
   </div>
</section>

<!-- kelola -->
<?php include"partials/kelola.php" ?>

<section class="seo-features new-seo-features c2a_5 bg_white" style="padding: 0px; 0px;">
   <div class="container">
      <div class="row d_flex">
         <div class="col-sm-6 col-xs-12 wow fadeInLeft">
            <div class="feature-shape"><img class="img-responsive" src="assets/landing/image/Followers-rafiki.png" alt="Image"></div>
         </div>
         <div class="col-sm-6 col-xs-12 d_flex wow fadeInRight">
            <div class="features-content flex">
               <h2 class="title">Beli Subscribers Youtube</h2>
               <p>Menambah subscriber akan sangat menguntungkan baik untuk meningkatkan reputasi dan kepercayaan customer serta juga untuk melengkapi persyartan monetisasi Youtube.</p>
            </div>
         </div>
      </div>
   </div>
      ...
      <div class="row d_flex row_reverse">
         <div class="col-sm-6 col-md-7 col-xs-12 wow fadeInRight">
            <div class="s_business_img">
               <div class="feature-shape"><img src="assets/landing/image/Followers-amico.png" alt="Image"></div>
            </div>
         </div>
         <div class="col-sm-6 col-md-5 col-xs-12 d_flex wow fadeInLeft">
            <div class="s_business_content flex">
               <h2 class="title">Beli Viewers Youtube</h2>
               <p>Layanan tambah viewers sangat penting bagi kalian yang ingin menginkatkan urutan atau ranking SEO. Bukan hanya untuk keperluan SEO namun semakin banyak jumlah view, semakin tinggi pula penghasilan yang anda dapatkan berkat monetisasi Youtube.</p>
            </div>
         </div>
      </div>
   </div>
...
<section class="seo-features new-seo-features c2a_5 bg_white" style="padding: 0px; 0px;">
   <div class="container">
      <div class="row d_flex">
         <div class="col-sm-6 col-xs-12 wow fadeInLeft">
            <div class="feature-shape"><img class="img-responsive" src="assets/landing/image/Followers-bro.png" alt="Image"></div>
         </div>
         <div class="col-sm-6 col-xs-12 d_flex wow fadeInRight">
            <div class="features-content flex">
               <h2 class="title">Beli Likes Youtube</h2>
               <p>Dengan semakin banyaknya interaksi atau jumlah like yang terdapat di akun Anda, maka akan semakin menarik dimata algoritma Youtube. Sehingga kemungkinan besar akun Anda bisa menempati urutan pertama di halaman pencarian.</p>
            </div>
         </div>
      </div>
   </div>
   ...
   <div class="container">
      <div class="sme_ig_service_tab_info">
         <div class="new_section_title_two new_section_title_three text-center">
            ...
            <h2 class="title">Paket Harga Youtube</h2>
         ...
         <div class="row">
            <div class="col-md-12 items-align-center">
               <div class="text-center m-t-30 m-b-40">
                  ...
                  <a class="service-menu-group selected" href="javascript:void(0);" data-card="tab-ea69ec28bcb1952b096267cc88060102">
                     <div class="media align-items-center">
                        ...
                        <span class="text-service mb-0">Likes</span>
                     </div>
                  </a>
                       
                  <a class="service-menu-group" href="javascript:void(0);" data-card="tab-ed4832a84ee072b00a6740f657183598">
                     <div class="media align-items-center">
                        <div class="avatar avatar-icon avatar-blue avatar-menu rounded m-r-10 m-l-20">
                           <i class="anticon anticon-eye font-size-30"></i>
                        </div>
                        <span class="text-service mb-0">Views</span>
                     </div>
                  </a>
                                                   </div>
            </div>
            <div class="col-md-12">
               <div class="tab-content new_service_content">
                  ...
                  <div class="card-service active" id="tab-ea69ec28bcb1952b096267cc88060102" sub-id="16">                                    
                     <div class="text-center justify-content-between align-items-center card-head m-b-30 modcard">
                        <div class="btn-group btn-group-social">
                                                      <button type="button" social-id="15" class="social-attr btn btn-default btn-lg biru active">
                           <span>Likes Mix</span>
                           </button>
                                                   </div>
                     </div>
                                       ...
                                       <div class="row" style="display:flex;">
                                          <div class="col-md-2 col-xs-2">
                                             <div class="d-inline-block" style="height: 83%;margin-top:50px;">
                                                <div class="vertical-default font-slider" id="slider-ea69ec28bcb1952b096267cc88060102"></div>
                                             </div>
                                          </div>
                  ...
                  <div class="card-service" style="display:none;"" id="tab-ed4832a84ee072b00a6740f657183598" sub-id="15">                                    
                     <div class="text-center justify-content-between align-items-center card-head m-b-30 modcard">
                        <div class="btn-group btn-group-social">
                                                      <button type="button" social-id="14" class="social-attr btn btn-default btn-lg biru active">
                           <span>Views Mix</span>
                           </button>
                                                   </div>
                     </div>
                                 ...
                                 <div class="col-md-12 card-head2 bg-wrapper">
                                    <div class="col-md-6 bg-price">
                                       <div class="row" style="display:flex;">
                                          <div class="col-md-2 col-xs-2">
                                             <div class="d-inline-block" style="height: 83%;margin-top:50px;">
                                                <div class="vertical-default font-slider" id="slider-ed4832a84ee072b00a6740f657183598"></div>
                                             </div>
                                          </div>
                                          <div class="col-md-10 col-xs-10 deskripsi">
                                             <h1><span class="package-name"></span></h1>
...
<!-- Keunggulan -->
<?php include"partials/keunggulan.php" ?>
      ...
      <div class="row">
         <div class="containcard">
            ...
            <div class="face face2">
                <div class="content">
                    <h3>
                        <a href="instagram.php" class="titlesosial">Instagram</a>
                    </h3>
                    <p>Followers Instagram | Likes Instagram | Viewers Instagram</p>
                </div>
            </div>
         </div>
         <div class="card">
            ...
            <div class="face face2">
                <div class="content">
                    <h3>
                        <a href="facebook.php" class="titlesosial">Facebook</a>
                    </h3>
         ...
         <div class="card">
            ...
            <div class="face face2">
                <div class="content">
                    <h3>
                        <a href="twitter.php" class="titlesosial">Twitter</a>
                    </h3>
                    <p>Beli Followers Twitter | Jasa Tambah Retweets Twitter | Jasa Tambah Likes Twitter</p>
                </div>
            </div>
         </div>
               </div>
...
<!-- Pertanyaan -->
<?php include"partials/pertanyaan.php" ?>
